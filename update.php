...
<head>
	<meta charset="utf-8">
	<title>platonicles Updater <?php echo UPDATER_VERSION ?></title>
...
<body>
	...
	<div id="container">
		...
		<footer>
			<p><a href="http://platonicles.com">platonicles <?php echo platonicles_VERSION ?> "<?php echo platonicles_NAME ?>"</a> © <?php echo date('Y') ?> | Developed by Marcos Fermin</p>
		</footer>
