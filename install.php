...
/*
 * For 1-Click Setup
 * This are the POST variables to install platonicles without the default form.
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' )
{
	...
	$obj->addChild('footer',				$_LANG['POWERED_BY_platonicles']);
	...
	$content = Text::replace_assoc(
			array(
				...
				'{{FACEBOOK_LINK}}'=>'<a target="_blank" href="https://www.facebook.com/platonicles">Facebook</a>',
				'{{TWITTER_LINK}}'=>'<a target="_blank" href="https://twitter.com/platonicles">Twitter</a>',
				'{{GOOGLEPLUS_LINK}}'=>'<a target="_blank" href="https://plus.google.com/+platonicles">Google+</a>'
			),
			$content
	);
...
<head>
	...
	<title>platonicles Installer</title>
...
<body>
	...
	<div id="container">
		...
		<header id="head">
			<?php
				echo '<p><center><img src="admin/templates/easy4/css/img/platonicles128.png"></center></p>';
				echo Html::h1( array('content'=>$_LANG['WELCOME_TO_platonicles']) );
			?>
		</header>
		...
		<section id="dependencies">
			...
			<?php
				...
				echo Html::div_open( array('class'=>'dependency') );
					echo Html::link( array('class'=>'description', 'content'=>$_LANG['WRITING_TEST_ON_CONTENT_DIRECTORY'], 'href'=>'http://wiki.platonicles.com/doku.php?id=how_to_set_up_permissions', 'target'=>'_blank') );
		...
		<footer>
			<p><a href="http://platonicles.com">platonicles <?php echo platonicles_VERSION ?> "<?php echo platonicles_NAME ?>"</a> © <?php echo date('Y') ?> | Developed by Marcos Fermin | <?php echo Html::link( array('content'=>$_LANG['EXPERT_MODE'], 'href'=>'./install.php?expert=true&language='.$_GET['language']) ) ?></p>
		</footer>
	...
	$(document).ready(function(){
		...
		$("#js_language").change(function () {
			...
			console.log("platonicles: Url="+url);
