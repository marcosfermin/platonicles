...
class Session {
	...
	{
		if(isset($_SESSION['platonicles'][$name]))
			return $_SESSION['platonicles'][$name];
		else
			return false;
	}
	...
	{
		$_SESSION['platonicles'][$key] = $value;
	}
	...
	{
		if(isset($_SESSION['platonicles']['error']))
		{
			return($_SESSION['platonicles']['error']);
		}
	...
	{
		if(isset($_SESSION['platonicles']['last_comment_at']))
		{
			return($_SESSION['platonicles']['last_comment_at']);
		}
	...
	{
		if(isset($_SESSION['platonicles']['last_session_at']))
		{
			return($_SESSION['platonicles']['last_session_at']);
		}
	...
	{
		if(isset($_SESSION['platonicles']['fail_session']))
		{
			return($_SESSION['platonicles']['fail_session']);
		}
	...
	{
		if(isset($_SESSION['platonicles']['comment'][$field]))
			return $_SESSION['platonicles']['comment'][$field];
	...
	{
		$_SESSION['platonicles']['comment'][$field] = $data;
	}

	public static function get_alert()
	{
		self::set_error(false);
		return($_SESSION['platonicles']['alert']);
	}

	public static function set_error($boolean = true)
	{
		$_SESSION['platonicles']['error'] = $boolean;
	}

	public static function set_last_comment_at($time)
	{
		$_SESSION['platonicles']['last_comment_at'] = $time;
	}

	public static function set_last_session_at($time)
	{
		$_SESSION['platonicles']['last_session_at'] = $time;
	}

	public static function set_fail_session($amount)
	{
		$_SESSION['platonicles']['fail_session'] = $amount;
	}

	public static function set_alert($text = '')
	{
		self::set_error(true);
		$_SESSION['platonicles']['alert'] = $text;
	}
